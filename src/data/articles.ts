...
export const ARTICLES: Article[] = [
  ...
  {
    id: 18, slug: "generic-medicines-safe",
    title: "Why Generic Medicines Are Safe",
    excerpt: "Generic medicines cost 80% less than branded drugs but work identically. Here's why Indians hesitate to use them — and why they shouldn't.",
    content: [
      "India is the world's largest generic medicine manufacturer. Yet many Indians still pay premium prices for branded drugs, believing they work better. The science says otherwise.",
      "**What generic medicines actually are.** When a branded drug's patent expires (usually 20 years), other manufacturers can produce chemically identical versions. These are called generics. They contain the same active ingredient, same strength, same dosage form.",
      "**They're not \"copies\" — they're the same drug.** A 500mg paracetamol tablet from a branded company and a generic company contain the same 500mg paracetamol. The molecule is identical. Your body can't tell the difference.",
      "**Bioequivalence is required by law.** India's CDSCO (Central Drugs Standard Control Organization) requires all generics to prove bioequivalence — meaning they release the drug into your bloodstream at the same rate and amount as the branded version.",
      "**Why they cost less.** Brand-name drugs include decades of R&D costs, clinical trials, and marketing. Generic manufacturers skip these costs — they just make the drug. That's why a branded cholesterol pill might cost ₹500 while the generic is ₹80.",
      "**Jan Aushadhi stores.** India's Pradhan Mantri Bhartiya Janaushadhi Pariyojana runs over 10,000 stores selling generic medicines at 50–90% off branded prices. A month's diabetes medication that costs ₹1,500 branded might be ₹150 generic.",
      "**When to be cautious.** Very narrow therapeutic index drugs (warfarin, thyroxine, epilepsy medications) may require closer monitoring if you switch between manufacturers. Discuss with your doctor before switching these specific drug categories.",
      "**Ask your doctor.** Next prescription, ask: \"Is there a generic version of this?\" Most doctors will happily prescribe the generic name or at least confirm the branded equivalent. Your wallet will thank you, and your treatment won't suffer.",
    ],
    category: "Medical", readTime: "5 min read", date: "February 5, 2026", author: "Dr. Vikram Singh",
    img: "https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=1200&q=80",
  },
  {
    id: 19, slug: "natural-immunity-boosters",
    title: "Building Immunity Naturally",
    excerpt: "Skip the expensive immunity supplements. These 8 evidence-based habits build lasting immune strength through nutrition, movement, sleep, and stress management.",
    content: [
      "\"Immunity boosters\" became a ₹20,000-crore industry after COVID. Most are marketing. Real immunity isn't boosted by a pill — it's built by consistent daily habits.",
      "**1. Sleep is the #1 immunity builder.** People sleeping less than 6 hours are 4x more likely to catch colds. Aim for 7–9 hours. Sleep is when your body produces infection-fighting cytokines and T-cells.",
      "**2. Vitamin D through sunlight.** 15–20 minutes of direct sun exposure (arms and face) 3–4 times weekly gives most Indians adequate vitamin D. Deficiency weakens immune response — and 70%+ of urban Indians are deficient.",
      "**3. Zinc-rich foods daily.** Pumpkin seeds, chickpeas, lentils, cashews, and curd provide zinc — crucial for T-cell function. A handful of pumpkin seeds daily covers most needs without supplements.",
    ...
    category: "Wellness", readTime: "7 min read", date: "February 2, 2026", author: "Dr. Priya Sharma",
    img: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=1200&q=80",
  },
  {
    id: 20, slug: "screen-time-health",
    title: "Screen Time and Your Health",
    excerpt: "The average Indian spends 7+ hours daily on screens. Here's how it affects your eyes, posture, sleep, and mental health — plus practical limits that actually work.",
    content: [
    ...
    category: "Wellness", readTime: "7 min read", date: "January 30, 2026", author: "Dr. Ananya Rao",
    img: "https://images.unsplash.com/photo-1499728603263-13726abce5fd?w=1200&q=80",
  },
];
